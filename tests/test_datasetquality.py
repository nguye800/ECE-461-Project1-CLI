...
#         self.assertEqual(metric.computeDatasetQuality("https://fakeurl.com"), 0.0)
...
#         self.assertGreater(metric.computeDatasetQuality("https://fakeurl.com"), 0.0)
...
#         metric.license = "apache-2.0"
#         self.assertEqual(metric.computeDatasetQuality("https://fakeurl.com"), 1.0)
